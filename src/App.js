  ...
  return (
    <div className='h-[100vh] w-full bg-black'>
      <div className='h-[300px] sm:bg-hero-pattern bg-hero-mobile bg-no-repeat bg-center bg-cover'>
        ...
        <div className='text-center pt-12 flex justify-center mx-3' onChange={onChangeIP}>
          <input className="rounded-l-lg h-12 lg:w-1/4 md:w-1/2 w-full px-4 focus:outline-none" placeholder='Search for any IP address or domain'/>
      ...
      <div className='absolute z-10 mx-3 lg:left-1/2 lg:ml-[-448px] grid md:grid-cols-4 sm:grid-cols-2 grid-cols-1 gap-4 p-8 sm:mt-[-75px] mt-[-125px] max-w-4xl bg-white rounded-xl shadow-lg'>
        ...
        <div className=' ml-2 md:border-r w-full pl-3 h-full border-neutral-200'>
          ...
          <p className='text-xl text-sans font-medium pt-2'>UTC -05:00</p>
        </div>
